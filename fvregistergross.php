                  ...
                  <div class="col-12">
                     <div class="page-title-box">
                        <div class="page-title-right">
                           <button class="btn btn-secondary waves-effect" data-toggle="collapse" href="#loadingregister_details"> <i class="ion ion-md-add mr-1"></i> <span>Add FV Register (Broker Wise) Details</span> </button>
                           <!-- <button class="btn btn-primary mb-30 d-inline-block"  ></button> -->
                        </div>
                        <h4 class="page-title">FV Register details</h4>
                     </div>
                  </div>
               </div>
                                    ...
                                    <div class="row">
                                       <div class="col-md-12">
                                          <div class="form-group">
                                             <h6 style="color: blue;text-align: center;" class="pull-right">Freight Voucher Register</h6>
                                             ...
                                             <div class="row">
                                                ...
                                                <div class="col-md-2">
                                                   <input type="button" name="" class="" value="show">
                                                </div>
                                             </div>
                                          </div>
                                       </div>
                                       ...
                                       <div class="col-md-12">
                                          <div class="form-group">
                                             ...
                                             <div class="row">
                                                <div class="col-md-6">
                                                   <select class="form-control">
                                                      <option>Fv Reg 1</option>
                                                   </select>
                                                </div>
                                                <div class="col-md-6">
                                                   <input type="file" name="" class="btn btn-secondary" value="....">
                                                </div>
                                             </div>
                                          </div>
                                       </div>
