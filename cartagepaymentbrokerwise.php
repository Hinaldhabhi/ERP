                  ...
                  <div class="col-12">
                     <div class="page-title-box">
                        <div class="page-title-right">
                           <button class="btn btn-secondary waves-effect" data-toggle="collapse" href="#loadingregister_details"> <i class="ion ion-md-add mr-1"></i> <span>Add Cartage Payment Register(Broker Wise) Details</span> </button>
                           <!-- <button class="btn btn-primary mb-30 d-inline-block"  ></button> -->
                        </div>
                        <h4 class="page-title">Cartage Payment Register  Details</h4>
                     </div>
                  </div>
               </div>
                                    ...
                                    <div class="row">
                                       <div class="col-md-12">
                                          <div class="form-group">
                                             <h6 style="color: blue;text-align: center;" class="pull-right">Cartage Payment Register</h6>
                                       ...
                                       <div class="col-md-12">
                                          <div class="form-group">
                                             ...
                                             <div class="row">
                                                <div class="col-md-6">
                                                   <select class="form-control">
                                                      <option>Crt Pay  Sum 1</option>
                                                   </select>
                                                </div>
                                                <div class="col-md-6">
                                                   <input type="file" name="form-control" class="" value="....">
                                                </div>
                                             </div>
                                          </div>
                                       </div>
