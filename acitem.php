               ...
               <div class="row">
                <div class="col-12">
                    <div class="page-title-box">
                        ...
                        <button class="btn btn-secondary waves-effect" data-toggle="collapse" href="#Ac_detail"> <i class="ion ion-md-add mr-1"></i> <span>Add Ac Item Details</span> </button>
                        <!-- <button class="btn btn-primary mb-30 d-inline-block"  ></button> -->
                        </div>
                        <h4 class="page-title">Ac Item Details</h4>
                    </div>
                </div>
            </div>
                                 ...
                                 <div class="row">
                                    <div class="col-md-12">
                                       <div class="form-group">
                                          <label for="userName"> A/C Item Name<span class="text-danger">*</span></label>
