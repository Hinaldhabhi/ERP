                     ...
                     <div id="challan_detail" class="collapse">
                              ...
                              <div class="card-box">
                                 <form class="form-horizontal" role="form">
                                    ...
                                    <div class="row">
                                       ...
                                       <div class="col-md-6">
                                          <button class="btn btn-secondary waves-effect waves-light">Select All</button>
                                       </div>
                                    </div>
                                 </form>
                              </div>
                        ...
                        <div class="row">
                           <div class="col-md-12">
                              <div class="row">
                                 <div class="col-sm-12">
                                    <table id="datatable" class="card-box table table-striped table-bordered dt-responsive nowrap dataTable no-footer dtr-inline" style="border-collapse: collapse; border-spacing: 0px; width: 100%;" role="grid" aria-describedby="datatable_info">
                                       <thead>
                                          <tr role="row">
