               ...
               <div class="row">
                <div class="col-12">
                    <div class="page-title-box">
                        ...
                        <button class="btn btn-secondary waves-effect" data-toggle="collapse" href="#material_detail"> <i class="ion ion-md-add mr-1"></i> <span>Add Material Details</span> </button>
                  ...
                  <div id="material_detail" class="collapse">
                                 ...
                                 <div class="row">
                                    <div class="col-md-12">
                                       <div class="form-group">
                                          ...
                                          <input type="text" name="nick" parsley-trigger="change" required="" placeholder="XYLOL-90" class="form-control" id="userName">
                                       </div>
                                    </div>
                                 </div>
