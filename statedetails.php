               ...
               <div class="row">
                <div class="col-12">
                    <div class="page-title-box">
                        ...
                        <button class="btn btn-secondary waves-effect" data-toggle="collapse" href="#state_detail"> <i class="ion ion-md-add mr-1"></i> <span>Add State</span> </button>
                  ...
                  <div id="state_detail" class="collapse">
                                 ...
                                 <div class="row">
                                    <div class="col-md-12">
                                       <div class="form-group">
                                          ...
                                          <input type="text" name="nick" parsley-trigger="change" required="" placeholder="Andman Nicobar" class="form-control" id="userName">
                                       </div>
                                    </div>
                                 </div>
