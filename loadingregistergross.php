                        ...
                        <div class="col-12">
                           <div class="page-title-box">
                              <div class="page-title-right">
                                 <button class="btn btn-secondary waves-effect" data-toggle="collapse" href="#loadingregister_details"> <i class="ion ion-md-add mr-1"></i> <span>Add Loading Register (Gross) Details</span> </button>
                                          ...
                                          <div class="row">
                                             <div class="col-md-12">
                                                <div class="form-group">
                                                   ...
                                                   <div class="col-md-10">
                                                       <select class="form-control">
                                                         <option>Loading Register Detail</option>
                                                      </select>
                                                   </div>
                                                   <div class="col-md-2">
