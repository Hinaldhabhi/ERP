                        ...
                        <div class="col-12">
                           <div class="page-title-box">
                              <div class="page-title-right">
                                 <button class="btn btn-secondary waves-effect" data-toggle="collapse" href="#loadingregister_details"> <i class="ion ion-md-add mr-1"></i> <span>Add FV OutStanding Details</span> </button>
                                 <!-- <button class="btn btn-primary mb-30 d-inline-block"  ></button> -->
                              </div>
                              <h4 class="page-title">FV Outstanding details</h4>
                           </div>
                        </div>
                     </div>
                                          ...
                                          <div class="row">
                                             <div class="col-md-12">
                                                <div class="form-group">
                                                   <h6 style="color: blue;text-align: center;" class="pull-right">FV OutStanding</h6>
                                             ...
                                             <div class="col-md-12">
                                                <div class="form-group">
                                                   ...
                                                   <div class="row">
                                                      <div class="col-md-10">
                                                         <select class="form-control">
                                                         <option>Fv Outstanding 1</option>
                                                         </select>
                                                      </div>
                                                      <div class="col-md-2">
