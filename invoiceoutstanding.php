                  ...
                  <div class="col-12">
                     <div class="page-title-box">
                        <div class="page-title-right">
                           <button class="btn btn-secondary waves-effect" data-toggle="collapse" href="#loadingregister_details"> <i class="ion ion-md-add mr-1"></i> <span>Add Invoice OutStanding Details</span> </button>
                           <!-- <button class="btn btn-primary mb-30 d-inline-block"  ></button> -->
                        </div>
                        <h4 class="page-title">Invoice Outstanding details</h4>
                     </div>
                  </div>
               </div>
                                    ...
                                    <div class="row">
                                       <div class="col-md-12">
                                          <div class="form-group">
                                             <h6 style="color: blue;text-align: center;" class="pull-right">Invoice OutStanding</h6>
                                       ...
                                       <div class="col-md-12">
                                          <div class="form-group">
                                             ...
                                             <div class="row">
                                                <div class="col-md-6">
                                                   <select class="form-control">
                                                      <option>Inv Outstanding 1</option>
                                                   </select>
                                                </div>
                                                <div class="col-md-6">
                                 ...
                                 <table  class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                    ...
                                    <tbody>
                                       <tr>
                                          <td></td>
                                          <td>27-06-20</td>
                                          <td>MALDEEP CATAYSIS PVT LTD.</td>
                                          <td>134190.00</td>
                                          <td>134190.00</td>
                                          <td></td>
                                          <td></td>
