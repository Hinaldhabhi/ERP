                           ...
                           <div class="card-box">
                              <form class="form-horizontal" role="form">
                                 ...
                                 <div class="row">
                                    <div class="col-md-12">
                                       <div class="form-group">
                                          <label for="userName"> Document Name<span class="text-danger">*</span></label>
                                          <input type="text" name="nick" parsley-trigger="change" required="" placeholder="RC Book" class="form-control" id="userName">
                                       </div>
                                    </div>
                                 </div>
